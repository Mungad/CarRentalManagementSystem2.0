...
import { createCustomerService, verifyCustomerService, customerLoginService, getCustomerService, getCustomerByIdService,getCustomerByEmailService, updateCustomerService, deleteCustomerService, getCustomerWithBookingsAndPaymentsService,getAllCustomersWithBookingsAndPaymentsService} from '../services/auth.service';
