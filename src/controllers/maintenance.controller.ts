...
import {createMaintenanceService,getAllMaintenanceService,getMaintenanceByIdService,updateMaintenanceService,deleteMaintenanceService} from '../services/maintenance.service';
...
export const getMaintenanceController = async (_req: Request, res: Response) => {
  try {
