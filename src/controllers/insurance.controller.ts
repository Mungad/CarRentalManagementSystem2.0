...
import {createInsuranceService,getInsuranceService,getInsuranceByIdService,updateInsuranceService,deleteInsuranceService} from '../services/insurance.service';
...
export const getInsuranceController = async (_req: Request, res: Response) => {
  try {
