...
import {createPaymentService,getPaymentService,getPaymentByIdService,getPaymentsByBookingIdService,updatePaymentService,deletePaymentService} from '../services/payment.service';
...
export const getPaymentController = async (_req: Request, res: Response) => {
  try {
